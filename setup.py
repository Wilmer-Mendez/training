...
if args.type == 'object_detection':
  command = """
    svn export -r 8436 https://github.com/tensorflow/models/trunk/research/object_detection and
    svn export -r 8436 https://github.com/tensorflow/models/trunk/research/slim and
